...
class ObjectiveCardDiagonalFungiTest {
    ...
    void calculatePointsSimpleCase() {
        try {
            ...
            gameField.place(new ResourceCard(3), true, 3,3);
    ...
    void calculatePointsDiagonalWith4CardsCase() {
        ...
        try {
            gameField.place(new ResourceCard(1), true, 1,1);
            gameField.place(new ResourceCard(2), true, 2,2);
            gameField.place(new ResourceCard(3), false, 3,3);
    ...
    void calculatePointsDoubleTripletCase() {
        try {
            ...
            gameField.place(new ResourceCard(5), true, 3,5);
            gameField.place(new ResourceCard(6), true, 4,6);
        } catch (CannotPlaceCardException e) {
            throw new RuntimeException(e);
        }
